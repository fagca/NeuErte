...
public class Users {
    ...
    */
    ...
    public void marriageStatus ()
    {
        if (marriageStatus.equalsIgnoreCase("married"))
        {
            ...
            System.out.print("Akrabanı eklemek istiyor musun?: 'evet' yada 'hayır'");
            String akrabaEkle = oku.nextLine();

            if (akrabaEkle.equalsIgnoreCase("evet"))
            {

                System.out.print("Akaraba ismin ne?: ");
                relativeName = AddRelative.fullName;

                System.out.println("Akrabanın yaşı nedir?: ");
                relativeAge = AddRelative.age;

                String c =  relativeAge.substring(6);
                int relA = Integer.parseInt(c);

                int yasRel = 2022 -relA;

                if (yasRel>=18)
                    System.out.println("Transaction done successfully");

                else System.out.println("You should be at least 18 years old to get a credit card.");
    ...
    */
    ...
    public static String   checkAge (String dob)
    {

        String a =  dob.substring(6);
        int dob2 = Integer.parseInt(a);
...
//--------------------------------------------------------------------------------------------------
    ...
    public void transfer(Users u1, Users u2)
    {
        ...
        System.out.println("Do you want to transfer between your 'own' accounts or 'different' user");
